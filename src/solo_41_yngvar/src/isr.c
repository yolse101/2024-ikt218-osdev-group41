...
// Initialize ISRs
void init_isr() { // Set up ISRs in the IDT
...
// ISR handler to print interrupt information
void isr_handler(registers_t r) {
    print("Received interrupt: ");
    char s[3]; // Declare char of size 3
    int_to_ascii(r.int_no, s); // Convert to ASCII
    print(s); // Print interrupt
    print(" - ");
    print(exceptions[r.int_no]); // Print label
    print("\n");
}
